...
/// Sample
///
/// class PlatformAppBar extends MxPlatform<AppBar, CupertinoNavigationBar, AppBar, AppBar> {
///   final Widget title;
...
///
abstract class MxPlatform<A extends Widget, I extends Widget, W extends Widget,
    D extends Widget> extends StatelessWidget {
  const MxPlatform({super.key});
