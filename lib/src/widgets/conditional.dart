/*
 * Copyright (c) 2023 Pawan Kumar. All rights reserved.
 *
...
class MxConditional extends StatelessWidget {
...
///
/// ```dart
///  MxConditionalSwitch.single<String>(
///         context: context,
...
///      ),
/// ```
class MxConditionalSwitch {
  MxConditionalSwitch._();
